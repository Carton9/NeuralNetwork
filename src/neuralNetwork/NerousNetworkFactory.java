...
public class NerousNetworkFactory {
	...
	public NerousNetworkFactory(int inputN,int hideN,int hideLevalN,int outputN){
		this.inputN=inputN;
		this.hideN=hideN;
	...
	public NerousNetworkFactory(int inputN,int hideN,int hideLevalN,int outputN,int mutationRate,
	...
	public NervousNetwork init(){
	NervousNetwork output=new NervousNetwork();
	/***********input***********/
	...
	public NerousNetworkFactory reproduction(){
		NerousNetworkFactory child=new NerousNetworkFactory(inputN,hideN,hideLevalN,outputN,
